	  ...
	  _createClass(Game, [{
	    ...
	    value: function addCells() {
	      ...
	      for (var i = 0; i < gameVars.NUM_CELLS; i++) {
	        ...
	        var cellPos = _utils.Util.randomPosition(gameVars.X_SIZE, gameVars.YSIZE);
	        cells.push(new _cells2.default({ vel: cellVel, pos: cellPos }));
	      }
	
	      var playerStart = _utils.Util.randomPosition(gameVars.X_SIZE, gameVars.YSIZE);
	      cells.push(new _player_cell2.default({ pos: playerStart }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerCell = function (_MovingObject) {
	  ...
	  function PlayerCell(options) {
	    ...
	    options.color = "red";
	    options.radius = 20;
	    return _possibleConstructorReturn(this, (PlayerCell.__proto__ || Object.getPrototypeOf(PlayerCell)).call(this, options));
	  }
	
	  _createClass(PlayerCell, [{
	    key: "move",
	    value: function move(impulse) {}
	  }]);
